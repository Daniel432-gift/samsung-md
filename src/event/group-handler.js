      ...
      for (const jid of participants) {
         ...
         if (action == "add" && config.WELCOME ) {
           const userName = jid.split("@")[0];
                    const joinTime = moment.tz('Africa/Arusha').format('HH:mm:ss');
                    const joinDate = moment.tz('Africa/Arusha').format('DD/MM/YYYY');
...
"`, contextInfo: {
           ...
           const userName = jid.split('@')[0];
                    const leaveTime = moment.tz('frica/Arusha').format('HH:mm:ss');
                    const leaveDate = moment.tz('frica/Arusha').format('DD/MM/YYYY');
                    const membersCount = metadata.participants.length;
            sock.sendMessage(id, {
