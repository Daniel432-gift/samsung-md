...
const alive = async (m, Matrix) => {
  ...
  if (['channel', 'support', 'samsung-support'].includes(cmd)) {
    const width = 800;
    const height = 500;
...
═════════════════════════════════════════════════════
║ 📢 **Group**                                       ║
║ ⤷ https://chat.whatsapp.com/BpYGkUYO7U10zP2FJ3VtP9  ║
═════════════════════════════════════════════════════
...
client.sendMessage(message.from, uptimeMessage, {quoted: message});
