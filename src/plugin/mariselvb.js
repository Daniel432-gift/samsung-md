...
const text = m.body.slice(prefix.length + cmd.length).trim();
    ...
    const validCommands = ['emojimix', 'emix', 'samsung-mix'];
    ...
    for (let res of anu.results) {
      const encmedia = await Matrix.sendImageAsSticker(m.from, res.url, m, { packname: "", author: "samsung_md", categories: res.tags });
