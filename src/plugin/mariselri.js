...
const text = m.body.slice(prefix.length + cmd.length).trim();
    ...
    const validCommands = ['kick', 'remove', 'samsung-out'];
    ...
    if (!botAdmin) return m.reply("*SAMSUNG MUST BE AN ADMIN TO USE THIS COMMAND*");
    ...
    await gss.groupParticipantsUpdate(m.from, validUsers, 'remove')
      .then(() => {
        ...
        m.reply(`*THIS IDIOT ${kickedNames} KICKED FROM OUR GROUP ${groupMetadata.subject}*`);
      })
