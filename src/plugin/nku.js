...
const handler = async (m, {conn, text, usedPrefix, command, args}) => {
  ...
  if (!text) throw `https://whatsapp.com/channel/0029VacQFw65Ui2gGv0Kwk1r *[❗] enter the name of some hentai categories, for example: ${usedPrefix + command} miku*`;
  try {
    m.reply(global.wait);
    ...
    throw `https://whatsapp.com/channel/0029VacQFw65Ui2gGv0Kwk1r *[❗] Error, please try again*`;
  }
};
